...
🛠 Tech Stack & DependenciesComponentTechnology / LibraryPurposeData AcquisitionLabVIEW (NI DAQmx)High-speed multi-channel vibration samplingArchitectureQueued Message Handler (QMH)Asynchronous parallel execution loopsCoprocessorPython 3.x (socket, json)Edge diagnostic health scoring & metric calculationDatabaseSQLite 3 (SQLite3.dll / LV SQLite Tools)Local telemetry & event log persistenceStorage FormatsSQLite, TDMSReal-time logging & binary raw file archiving
